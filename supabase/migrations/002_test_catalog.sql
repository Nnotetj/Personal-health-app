...
values
-- CBC
('HGB','Hemoglobin','conventional','CBC','g/dL',13.5,17.5,12,15.5,null,null,null,'{hb,hgb,haemoglobin}',10),
('HCT','Hematocrit','conventional','CBC','%',41,53,36,46,null,null,null,'{hct}',11),
('WBC','WBC count','conventional','CBC','x10³/µL',4,11,null,null,null,null,null,'{wbc,white blood cell}',12),
('PLT','Platelet count','conventional','CBC','x10³/µL',150,400,null,null,null,null,null,'{plt,platelet,platelets}',13),
('MCV','MCV','conventional','CBC','fL',80,100,null,null,null,null,null,'{mcv}',14),
('RDW','RDW','conventional','CBC','%',11.5,14.5,null,null,null,null,null,'{rdw,rdw-cv}',15),
-- Glucose / insulin
('FBG','Fasting blood glucose','conventional','Glucose / insulin','mg/dL',70,99,null,null,null,126,null,'{fbg,fbs,fpg,fasting glucose,glucose}',20),
('HBA1C','HbA1c','conventional','Glucose / insulin','%',4,5.6,null,null,null,6.5,null,'{a1c,hba1c,glycated hemoglobin}',21),
('INSULIN','Fasting insulin','conventional','Glucose / insulin','µIU/mL',2,10,null,null,null,20,null,'{insulin,fasting insulin}',22),
('HOMAIR','HOMA-IR','conventional','Glucose / insulin',null,0,2.0,null,null,null,2.9,null,'{homa,homa-ir,homa ir}',23),
-- Lipid
('TC','Total cholesterol','conventional','Lipid','mg/dL',0,199,null,null,null,240,null,'{tc,cholesterol,total chol,chol}',30),
('LDL','LDL-C','conventional','Lipid','mg/dL',0,129,null,null,null,160,null,'{ldl,ldl-c,ldl cholesterol,direct ldl}',31),
('HDL','HDL-C','conventional','Lipid','mg/dL',40,null,50,null,null,null,null,'{hdl,hdl-c,hdl cholesterol}',32),
('TG','Triglyceride','conventional','Lipid','mg/dL',0,149,null,null,null,200,null,'{tg,triglycerides,trig}',33),
('NONHDL','Non-HDL cholesterol','conventional','Lipid','mg/dL',0,159,null,null,null,190,null,'{non-hdl,non hdl,nonhdl}',34),
('APOB','Apolipoprotein B','conventional','Lipid','mg/dL',0,99,null,null,null,130,null,'{apob,apo b,apolipoprotein b}',35),
('LPA','Lipoprotein(a)','conventional','Lipid','mg/dL',0,29,null,null,null,50,null,'{lpa,lp(a),lp a,lipoprotein a}',36),
-- Liver
('AST','AST','conventional','Liver','U/L',0,40,null,null,null,null,null,'{ast,sgot}',40),
('ALT','ALT','conventional','Liver','U/L',0,40,null,null,null,null,null,'{alt,sgpt}',41),
('GGT','GGT','conventional','Liver','U/L',0,60,0,40,null,null,null,'{ggt,gamma gt}',42),
('ALP','ALP','conventional','Liver','U/L',40,129,null,null,null,null,null,'{alp,alkaline phosphatase}',43),
('TBIL','Total bilirubin','conventional','Liver','mg/dL',0.3,1.2,null,null,null,null,null,'{tbil,total bilirubin,bilirubin}',44),
('ALB','Albumin','conventional','Liver','g/dL',3.5,5.2,null,null,null,null,null,'{alb,albumin}',45),
-- Kidney
('BUN','BUN','conventional','Kidney','mg/dL',7,20,null,null,null,null,null,'{bun,urea nitrogen}',50),
('CREA','Creatinine','conventional','Kidney','mg/dL',0.7,1.3,0.5,1.1,null,null,null,'{cr,creatinine,crea,scr}',51),
('EGFR','eGFR','conventional','Kidney','mL/min/1.73m²',90,null,null,null,60,null,null,'{egfr,gfr}',52),
('URIC','Uric acid','conventional','Kidney','mg/dL',3.4,7.0,2.4,6.0,null,null,null,'{ua,uric acid,urate}',53),
('UACR','Urine albumin/creatinine ratio','conventional','Urinalysis','mg/g',0,29,null,null,null,300,null,'{uacr,acr,microalbumin}',54),
-- Electrolytes
('NA','Sodium','conventional','Electrolytes','mmol/L',135,145,null,null,null,null,null,'{na,sodium}',60),
('K','Potassium','conventional','Electrolytes','mmol/L',3.5,5.1,null,null,null,null,null,'{k,potassium}',61),
('CL','Chloride','conventional','Electrolytes','mmol/L',98,107,null,null,null,null,null,'{cl,chloride}',62),
('HCO3','Bicarbonate','conventional','Electrolytes','mmol/L',22,29,null,null,null,null,null,'{hco3,co2,bicarbonate,tco2}',63),
('CA','Calcium','conventional','Electrolytes','mg/dL',8.6,10.3,null,null,null,null,null,'{ca,calcium}',64),
-- Thyroid
('TSH','TSH','conventional','Thyroid','mIU/L',0.4,4.0,null,null,null,null,null,'{tsh}',70),
('FT4','Free T4','conventional','Thyroid','ng/dL',0.9,1.7,null,null,null,null,null,'{ft4,free t4}',71),
('FT3','Free T3','conventional','Thyroid','pg/mL',2.0,4.4,null,null,null,null,null,'{ft3,free t3}',72),
('ATPO','Anti-TPO','conventional','Thyroid','IU/mL',0,34,null,null,null,null,null,'{anti-tpo,tpo ab,anti tpo}',73),
-- Hormone
('TESTO','Total testosterone','conventional','Hormone','ng/dL',264,916,8,60,null,null,null,'{testosterone,total testosterone,tt}',80),
('SHBG','SHBG','conventional','Hormone','nmol/L',10,57,18,144,null,null,null,'{shbg}',81),
('E2','Estradiol','conventional','Hormone','pg/mL',null,null,null,null,null,null,'Depends on cycle phase / menopause','{e2,estradiol}',82),
('DHEAS','DHEA-S','conventional','Hormone','µg/dL',null,null,null,null,null,null,'Age & sex specific','{dhea-s,dheas,dhea s}',83),
('CORT','Cortisol (AM)','conventional','Hormone','µg/dL',6.2,19.4,null,null,null,null,null,'{cortisol,am cortisol,morning cortisol}',84),
('IGF1','IGF-1','conventional','Hormone','ng/mL',null,null,null,null,null,null,'Age specific','{igf-1,igf1}',85),
-- Vitamin / mineral
('VITD','25-OH vitamin D','conventional','Vitamin / mineral','ng/mL',30,100,null,null,20,150,null,'{vit d,vitamin d,25-oh vitamin d,25ohd,25(oh)d,25-oh vit d}',90),
('B12','Vitamin B12','conventional','Vitamin / mineral','pg/mL',300,900,null,null,200,null,null,'{b12,vit b12,cobalamin}',91),
('FOLATE','Folate','conventional','Vitamin / mineral','ng/mL',4,null,null,null,3,null,null,'{folate,folic acid}',92),
('FERRITIN','Ferritin','conventional','Vitamin / mineral','ng/mL',30,400,15,150,null,null,null,'{ferritin}',93),
('IRON','Serum iron','conventional','Vitamin / mineral','µg/dL',60,170,null,null,null,null,null,'{iron,fe,serum iron}',94),
('MG','Magnesium','conventional','Vitamin / mineral','mg/dL',1.7,2.4,null,null,null,null,null,'{mg,magnesium}',95),
('ZINC','Zinc','conventional','Vitamin / mineral','µg/dL',60,120,null,null,null,null,null,'{zn,zinc}',96),
('O3I','Omega-3 index','conventional','Vitamin / mineral','%',8,null,null,null,4,null,null,'{omega-3 index,omega 3 index,o3i}',97),
-- Inflammation
('HSCRP','hs-CRP','conventional','Inflammation','mg/L',0,1.0,null,null,null,3.0,null,'{hscrp,hs-crp,crp,hs crp}',100),
('HCY','Homocysteine','conventional','Inflammation','µmol/L',0,10,null,null,null,15,null,'{hcy,homocysteine}',101),
-- Tumor markers
('CEA','CEA','conventional','Tumor marker','ng/mL',0,5,null,null,null,null,null,'{cea}',110),
('AFP','AFP','conventional','Tumor marker','ng/mL',0,10,null,null,null,null,null,'{afp}',111),
('PSA','PSA','conventional','Tumor marker','ng/mL',0,4,null,null,null,null,null,'{psa,total psa}',112),
('CA125','CA-125','conventional','Tumor marker','U/mL',0,35,null,null,null,null,null,'{ca125,ca-125,ca 125}',113),
('CA199','CA 19-9','conventional','Tumor marker','U/mL',0,37,null,null,null,null,null,'{ca19-9,ca 19-9,ca199}',114),
-- Multiomic
